...
|-----|------|-------|------|
|[1. Расчет пола будущего ребенка](https://github.com/Yandex_Praktikum/tree/master/01_Исследование%20надёжности%20заёмщиков)|Предсказание пола будущего ребенка по дате рождиения родителей и дате зачатия |Банковская сфера Кредитование|*Pandas, PyMystem3, Python, лемматизация*|
